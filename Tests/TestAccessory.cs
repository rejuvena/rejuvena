    ...
    public class TestAccessory : AccessoryItem
    {
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (Main.GameUpdateCount % 4 == 0)
                DrawEffectManager.Instance.DrawEffects.Add(new TestSparkle(player.position + new Vector2(Main.rand.Next(player.width), Main.rand.Next(player.height)), Vector2.Zero));
        }
    }
}
#endif